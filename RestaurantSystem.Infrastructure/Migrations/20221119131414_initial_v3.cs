        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastsNames = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceCharge", x => new { x.InvoiceId, x.ChargeId });
                    table.ForeignKey(
                        name: "FK_InvoiceCharge_Charges_ChargeId",
                        column: x => x.ChargeId,
                        principalTable: "Charges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceCharge_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheffId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_CheffId",
                        column: x => x.CheffId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceDetails_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceCharge_ChargeId",
                table: "InvoiceCharge",
                column: "ChargeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetails_MenuItemId",
                table: "InvoiceDetails",
                column: "MenuItemId");
